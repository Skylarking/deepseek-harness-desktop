/** Package-owned invariant companion for the Workspace files bundle. @module @deepseek-ai/dsh-workspace-files/invariant */
...
export const name = 'workspace-files-bundle-invariant'
