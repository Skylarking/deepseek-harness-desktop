/** Desktop-managed Host plugin inventory registered into Web Settings. */
...
export function apply(ctx: ClientContext): void {
  ...
  const manager = (window as Window & { dshDesktopPlugins?: DesktopPluginManager }).dshDesktopPlugins
  const injected = (): PluginInventorySettingsTabInjected => ({ list, ...(manager === undefined ? {} : { manager }) })
