/** Package-owned invariant companion for the Workspace console bundle. @module @deepseek-ai/dsh-workspace-console/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-workspace-console'
